...
* `/etc/emulationstation/themes/[CURRENT_THEME_SET]/[SYSTEM_THEME]/theme.xml` (please note that in Gamestation, `/etc/emulationstation/` points to SHARE_INIT that is read only)
