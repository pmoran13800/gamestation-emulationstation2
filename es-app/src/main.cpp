	...
	*errorString = NULL;
	...
	if(SystemData::sSystemVector.size() == 0)
	{
		...
		*errorString = "WE CAN'T FIND ANY SYSTEMS!\n"
		  ...
		  "\n"
		  "VISIT GAMESTATION.FR FOR MORE INFORMATION.";
		return false;
	}
...
int main(int argc, char* argv[])
{
	...
	archFile.open("/gamestation/gamestation.arch");
    ...
    std::string changelog = GamestationUpgrade::getInstance()->getChangelog();
    if (changelog != "") {
        ...
        window.pushGui(
                new GuiMsgBoxScroll(
						...
						message, _("OK"),
                        [] {
                            GamestationUpgrade::getInstance()->updateLastChangelogFile();
