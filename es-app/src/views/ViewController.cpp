...
void ViewController::goToStart()
{
	...
	if (GamestationConf::getInstance()->get("emulationstation.hidesystemview") == "1" || GamestationConf::getInstance()->get("emulationstation.bootongamelist") == "1")
...
std::shared_ptr<IGameListView> ViewController::getGameListView(SystemData* system)
{
	...
	if(detailed && ! (GamestationConf::getInstance()->get("emulationstation.forcebasicgamelistview") == "1"))
...
bool ViewController::input(InputConfig* config, Input input)
{
	...
	// open menu
	if(config->isMappedTo("start", input) && input.value != 0 && GamestationConf::getInstance()->get("emulationstation.menu") != "none" )
	{
		// open menu
...
std::vector<HelpPrompt> ViewController::getHelpPrompts()
{
	...
	if(GamestationConf::getInstance()->get("emulationstation.menu") != "none"){
...
int ViewController::getFirstSystemIndex() {
	std::string systemName = GamestationConf::getInstance()->get("emulationstation.selectedsystem");
	if(systemName != ""){
