...
const char* MenuMessages::START_KODI_HELP_MSG = "Start RH Mediastation.";
const char* MenuMessages::SYSTEM_HELP_MSG = "Select the language for your gamestation, select an external drive to store your games and configurations, check your current version and the free space on your drive";
const char* MenuMessages::VERSION_HELP_MSG = "Shows your current gamestationOS version.";
...
const char* MenuMessages::STORAGE_DEVICE_HELP_MSG = "Select an external drive to store your roms, saves, configurations etc.\nUse a FAT32 formatted drive. The system does not format the drive. On first boot, with this option enabled, gamestation will create a '/gamestation' folder with all system files inside.";
const char* MenuMessages::LANGUAGE_HELP_MSG = "Select your language. A reboot is needed to set this configuration active.";

const char* MenuMessages::UPDATE_HELP_MSG = "Manage your gamestation updates. Select the update type. Activate update check.";
const char* MenuMessages::START_UPDATE_HELP_MSG = "Check if an update is available, and start the update process.";
const char* MenuMessages::UPDATE_TYPE_HELP_MSG = "Stable updates will check for updates on stable gamestation releases. Stable updates are tested and approved by the gamestation team and their testers.\nUnstable updates allows you to get the latest gamestation features by checking our unstable repository. You can test and validate with us the very last version of gamestation.\nIf you choose unstable update, be so kind to report issues on the gamestation-os issue board (https://github.com/gamestation/gamestation-os/issues)";
...
const char* MenuMessages::CONTROLLER_BT_HELP_MSG = "Pair a bluetooth controller with your gamestation. Your controller must be in pairing mode.";
...
const char* MenuMessages::UI_HELP_MSG = "Configure your EmulationStation experience. Select transition types, help prompts, screensaver behavior. You can also deactivate the onscreen keyboard if you have a real keyboard plugged into your gamestation.\nIf you've added games since the last boot, you can also refresh the gamelist from this menu.";
...
const char* MenuMessages::UI_KEYBOARD_HELP_MSG = "The onscreen keyboard is necessary to type text if you only have controllers plugged into your gamestation. You can disable it if you have a real keyboard connected.";
...
const char* MenuMessages::UI_THEME_HELP_MSG = "Select a theme for your gamestation.";
...
const char* MenuMessages::SOUND_HELP_MSG = "Configure the sound options of your gamestation.";
const char* MenuMessages::SOUND_VOLUME_HELP_MSG = "Set the volume of the sound output for the frontend and the games.";
const char* MenuMessages::SOUND_FRONTEND_MUSIC_HELP_MSG = "Enable or disable the frontend music. You can add your own music as mp3, or ogg format in the 'musics' directory of your gamestation.";
const char* MenuMessages::SOUND_DEVICE_HELP_MSG = "Select your output device. Only HDMI and JACK are supported.";

const char* MenuMessages::NETWORK_HELP_MSG = "Configure the network options of your gamestation.\nCheck your network status and IP address, set the hostname and configure the WIFI.";
const char* MenuMessages::NETWORK_STATUS_HELP_MSG = "Displays CONNECTED, if you are connected, by checking if your gamestation can access the gamestation.com update server.";
const char* MenuMessages::NETWORK_IP_HELP_MSG = "The IP address of your gamestation within your local network.";
...
const char* MenuMessages::NETWORK_HOST_HELP_MSG = "The name of your gamestation in your local network";
...
const char* MenuMessages::ADVANCED_BOOT_ON_SYSTEM_HELP_MSG = "Select which system to show when the gamestation frontend starts. The default value is 'favorites'.";
const char* MenuMessages::ADVANCED_BOOTGAMELIST_HELP_MSG = "On boot, gamestation will show the list of games of the selected system rather than the system view.";
...
const char* MenuMessages::ADVANCED_EMULATOR_ADVANCED_HELP_MSG = "Override global options like emulator, core, ratio and more for each available system in your gamestation.";
const char* MenuMessages::ADVANCED_BOOT_HELP_MSG = "Configure boot options that make your gamestation boot straight into a system or into Kodi, lock a user to a single system, or directly show the gamelist.";
...
const char* MenuMessages::ADVANCED_SECURITY_HELP_MSG = "Manage your gamestation security.";
const char* MenuMessages::ADVANCED_ROOT_PWD_HELP_MSG = "Change the SSH root password.";
const char* MenuMessages::ADVANCED_ENFORCE_SECURITY_HELP_MSG = "Enforce gamestation security.";
...
const char* MenuMessages::ADVANCED_MANAGER_HELP_MSG = "Enable or disable the Gamestation Manager.\nThe Gamestation Manager is a web application available on http://gamestation , if you are on windows, http://gamestation.local , if you are on Linux or Mac, or directly with your gamestation IP : http://192.168.1.XX.\nYou can configure many options from within the manager, and even manage games, saves, and scrapes!";
const char* MenuMessages::ADVANCED_API_HELP_MSG = "Enable or disable the gamestation API.\nThe Gamestation API is a REST API exposing endpoints to control your gamestation via http requests.";
