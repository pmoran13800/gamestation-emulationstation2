...
std::vector<const char *> settings_dont_save = boost::assign::list_of
        ...
        ("VersionFile")
        ("SharePartition")
        ("GamestationSettingScript")
        ("GamestationConfigScript")
        ("LastVersionFile")
        ("VersionMessage")
        ("MusicDirectory")
		("ThemeChanged")
...
void Settings::setDefaults() {
    ...
    mStringMap["UpdateCommand"] = "/gamestation/scripts/gamestation-upgrade.sh";
    mStringMap["UpdateServer"] = "archive.gamestation.com";
    mStringMap["VersionFile"] = "/gamestation/gamestation.version";
    mStringMap["UpdateVersionFile"] = "/gamestation/share/system/upgrade/gamestation.version.update";
    mStringMap["SharePartition"] = "/gamestation/share/";
    mStringMap["GamestationSettingScript"] = "/gamestation/scripts/gamestation-config.sh";
    mStringMap["GamestationUpgradeScript"] = "/gamestation/scripts/upgrade/gamestation-upgrade.sh";
    mStringMap["LastChangelog"] = "/gamestation/share/system/gamestation.changelog.done";
    mStringMap["UpdateChangelog"] = "/gamestation/share/system/upgrade/gamestation.changelog.update";
    mStringMap["Changelog"] = "/gamestation/gamestation.changelog";
    mStringMap["MusicDirectory"] = "/gamestation/share/music/";
